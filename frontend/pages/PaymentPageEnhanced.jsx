...
function PaymentPageEnhanced() {
    ...
    const mockOrderData = {
        products: [
            {
                name: "Croma 80 cm (32 inch) HD Ready LED TV",
                price: 7390,
                quantity: 1,
            ...
            {
                name: "Croma 6.5 kg 5 Star Washing Machine",
                price: 11290,
                quantity: 1,
        ...
        shippingAddress: {
            name: "Whoopi Cherry",
            tag: "WORK",
            address: "Omnis Culpa Vel Voluptas Ut A Porro Beatae, Surat, Gujarat - 395006"
        }
    };
    ...
    const upiApps = [
        { name: "PhonePe", logo: "https://via.placeholder.com/40x40?text=PP" },
        { name: "Google Pay", logo: "https://via.placeholder.com/40x40?text=GP" },
        { name: "Paytm", logo: "https://via.placeholder.com/40x40?text=PT" },
        { name: "BHIM", logo: "https://via.placeholder.com/40x40?text=BH" }
    ];
